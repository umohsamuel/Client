...
export class Sidebar extends Component {
  render() {
    return (
      <aside className="bg-[#F5F0EF] flex flex-col justify-center items-center overflow-x-hidden">
        {/* Vertical line  */}
        <div className=" h-[200vh] border-r-2 border-[#CFCEED] absolute left-64 top-0"></div>

        <ul className=" h-[170vh] w-[16em] pt-5  flex flex-col  items-center gap-4">
