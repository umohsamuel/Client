  ...
  return (
    <div className="">
      ...
      <div className="relative flex w-[100%]  justify-between ">
        ...
        >
          <section className="  p-10 bg-white w-full h-[95%] tablet:rounded-2xl tablet:border-2 border-[#CFCEED] pl-14 flex flex-col justify-center mobile:ml-[1.5em]  tablet:ml-0">
